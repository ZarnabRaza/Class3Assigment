...
function tempInFarenhite(_temp) {
    return _temp * (9 / 5) + 32;
}
;
...
function obtainedMarks(obtainedMarks, totalMarks) {
...
function discount(currentPrice) {
    if (currentPrice > 100) {
...
var givenPrice = 100;
var discount10Percentage = (givenPrice * 90) / 100;
var discount5Percentage = (givenPrice * 95) / 100;
if (givenPrice > 100) {
...
var unit = 600;
var unitPrice = 15;
var amountOfTheBill = unit * unitPrice;
if (unit > 100) {
